...
typesetting material and primitive commands, in our case, the `\TeX` macro. 
...
* The comment character `%` is ignored and all the text after it to the end of line
  is ignored too. No space is added.
...
in horizontal mode or one above another in vertical mode. 
...
If a glue is put on the horizontal data row in horizontal mode and the
